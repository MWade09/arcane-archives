...
export default function MarsNav() {
  ...
  useEffect(() => {
    ...
    const revealEls = document.querySelectorAll(
      '.chapter-header, .chapter-body > *, .info-card, .mtriad-item, .engineer-item, .blood-event, .twin-pole, .toc-card'
    )
  ...
  return (
    <nav className={`site-nav${visible ? ' is-visible' : ''}`} aria-label="Site navigation">
      <Link href="/mars#top" className="site-nav__brand">♂ Mars</Link>
